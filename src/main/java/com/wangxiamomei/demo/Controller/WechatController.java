...
public class WechatController {
    ...
    public String authorize(@RequestParam("returnUrl") String returnUrl){
        ...
        String result = null;
        try {
             result = URLEncoder.encode(returnUrl,"utf-8");
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        String redirectUrl = wxMpService.oauth2buildAuthorizationUrl(url, WxConsts.OAUTH2_SCOPE_USER_INFO,result);
        log.info("【微信网页授权】 获取code，redirectUrl={}",redirectUrl);
        log.info("【微信网页授权】 获取code，returnUrl={}",result);
